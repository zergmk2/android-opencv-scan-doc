...
//        setContentView(R.layout.activity_main);
    ...
    protected void findEdges(ImageView img) {
...
//    protected Mat computeDstMatPoints (Mat src) {
//        double x1 = l1._p1.x, x2= l1._p2.x, y1 = l1._p1.y, y2 = l1._p2.y;
//        double x3 = l2._p1.x, x4 = l2._p2.x, y3 = l2._p1.y, y4 = l2._p2.y;
//
//        double w1 = Math.sqrt( Math.pow(x4 - x3 , 2) + Math.pow(x4 - x3, 2));
//        double w2 = Math.sqrt( Math.pow(x2 - x1 , 2) + Math.pow(x2-x1, 2));
//        double h1 = Math.sqrt( Math.pow(y2 - y4 , 2) + Math.pow(y2 - y4, 2));
//        double h2 = Math.sqrt( Math.pow(y1 - y3 , 2) + Math.pow(y1-y3, 2));
//
//        double maxWidth = (w1 < w2) ? w1 : w2;
//        double maxHeight = (h1 < h2) ? h1 : h2;
//
//        Mat dst = Mat.zeros((int)maxHeight, (int)maxHeight, CvType.CV_8UC3);
//        return dst;
//    }
